      ...
      <div className="p-8">
          ...
          {isLoading ? (
            ...
            <>
              ...
              <StatCard
                ...
                value={String(data.avgMessagesPerSession)}
              />
              <StatCard
                label="Peak Hour"
                value={formatHour(data.peakHour)}
                sub="most sessions started"
              />
              <StatCard
                label="Top Model"
                value={data.topModel}
        ...
        <div className="border border-border p-6 mb-6">
          ...
          {isLoading ? (
            ...
            <BarChart data={hourData} layout="horizontal" height={280} />
          )}
        </div>
        ...
        {data?.longestSession && (
          <div className="border border-border p-6">
            <h3 className="text-[11px] uppercase tracking-[0.05em] font-semibold text-muted mb-3">
              Longest session
            </h3>
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="font-display text-lg font-bold">
                  {data.longestSession.messageCount}
                </p>
              </div>
              <div>
