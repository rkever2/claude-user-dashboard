...
export function OverviewPage() {
	...
	const directTokens = overview ? overview.totalInputTokens + overview.totalOutputTokens : 0;
						...
						columns={[
							{
								key: "name",
								header: "Project",
								render: (row: (typeof topProjects)[0]) => <span className="font-medium">{row.displayName}</span>,
							},
							{
								key: "sessions",
								header: "Sessions",
