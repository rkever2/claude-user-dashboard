        ...
        <div className="border border-border">
          ...
          <DataTable
            columns={[
              ...
              { key: "cacheRead", header: "Cache Read", align: "right", render: (row) => formatTokens(row.cacheReadTokens) },
              { key: "cacheWrite", header: "Cache Write", align: "right", render: (row) => formatTokens(row.cacheWriteTokens) },
